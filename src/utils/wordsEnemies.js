...
const wordsEnemies = [
  ...
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'easy', word: 'niño' },
  ...
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'easy', word: 'luz' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'easy', word: 'árbol' },
  ...
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'easy', word: 'jamón' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'easy', word: 'pan' },
  ...
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'montaña' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'teléfono' },
  ...
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'furgoneta' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'mochila' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'pirámide' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'estrella' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'helicóptero' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'lámpara' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'televisor' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'escritorio' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'calculadora' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'ventilador' },
  ...
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'bicicleta' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'microscopio' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'barco' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'murciélago' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'hipopótamo' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'helicóptero' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'micrófono' },
  ...
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'portátil' },
  { color: colors[Math.floor(Math.random() * colors.length)], difficulty: 'normal', word: 'avión' },
